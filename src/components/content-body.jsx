    ...
    return (
        ...
        <div className='bg-gray-100 pt-5'>
            <div className="flex flex-col  gap-6 md:flex-row mx-10 md:mx-40 md:items-center md:justify-center">
                <div className=' md:w-2/3 text-start order-2 text-xl md:order-1'>
            ...
            <div className=" flex flex-wrap pb-10 justify-center gap-4 text-center mt-12">
               <div className=' rounded-xl w-[300px] bg-white shadow-sm '>
                    ...
                    <p className='text-blue-600'> <Link to='/clinics'> Browse Clinics </Link></p>
               </div>
               ...
               <div className=' rounded-xl w-[300px] bg-white shadow-sm '>
                    ...
                    <p className='text-blue-600'>Find Support </p>
               </div>
               ...
               <div className=' rounded-xl w-[300px] bg-white shadow-sm '>
                    ...
                    <p className='text-blue-600'> <Link to='/live'>Connect</Link></p>
               </div>
               ...
               <div className=' rounded-xl w-[300px] bg-white shadow-sm '>
                    ...
                    <p className='text-blue-600 hover:underline'> <Link to='/doctor'> Book </Link></p>
               </div>
